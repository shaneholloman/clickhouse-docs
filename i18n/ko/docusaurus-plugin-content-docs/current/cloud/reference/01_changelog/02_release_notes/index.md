...
{/* 아래 목차는 YAML front matter를 기반으로
     https://github.com/ClickHouse/clickhouse-docs/blob/main/scripts/autogenerate-table-of-contents.sh 스크립트를 사용해 자동 생성됩니다.
     오류를 발견한 경우 해당 페이지의 frontmatter를 직접 수정하십시오.
  */ }
...
| Page                                                      | Description                                                     |
| --------------------------------------------------------- | --------------------------------------------------------------- |
| [Cloud changelog - 2026](/whats-new/cloud)                | 각 ClickHouse Cloud 릴리스에서 새로 추가된 내용을 설명하는 ClickHouse Cloud 변경 로그 |
