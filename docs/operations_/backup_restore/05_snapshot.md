...
The lightweight path applies to [SharedMergeTree](/engines/table-engines/mergetree-family/shared-merge-tree), SharedSet, and SharedJoin tables. For all other engine types — such as Log or Memory — the backup falls back to a standard copy-based backup automatically.
